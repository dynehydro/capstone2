...
class Gallery {
    ...
    public function update_gallery($gallery_name, $gallery_description, $gallery_curator, $gallery_link, $gallery_image, $gallery_location, $gallery_contact_no, $id) {
        try {
            $sql = "UPDATE tbl_gallery 
            ...
            echo "Error updating gallery: " . $e->getMessage();
            return false;
        }
    }
    ...
    public function delete_gallery($id) {
        $sqlArtPieces = "DELETE FROM tbl_art_pieces WHERE gallery_id = :gallery_id";
        $qArtPieces = $this->conn->prepare($sqlArtPieces);
        $qArtPieces->execute(array(':gallery_id' => $id));    
    ...
    function get_gallery_id($id) {
        $sql = "SELECT gallery_id FROM tbl_gallery WHERE gallery_id = :id";
        $q = $this->conn->prepare($sql);
        $q->execute(['id' => $id]);
        return $q->fetchColumn();
    }
