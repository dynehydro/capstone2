    ...
    <form method="POST" action="processes/process.art.php?action=create" enctype="multipart/form-data">
        <div>
            ...
            <script>
                ...
                // Function to combine height, width, and unit into a single dimension string
                ...
                // Add event listeners to update dimensions on change
                document.getElementById("artpiece_height").addEventListener("input", combineDimensions);
                document.getElementById("artpiece_width").addEventListener("input", combineDimensions);
                document.getElementById("artpiece_unit").addEventListener("change", combineDimensions);
            </script>
